...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		double costOfMilk = 2.80, thirstLevel = 2;
		...
		int numberOfCookies = 12, numberOfChildren = 5;
		...
		case "PLATINUM": loyaltyMemberDiscount = 0.25;
			break;
		default: loyaltyMemberDiscount = 0.0;
		}
		...
		double billTotal = 45.00;
		double adjustedTotal = billTotal - (billTotal*loyaltyMemberDiscount);
		if (adjustedTotal > 500.0) {
			switch (loyaltyMemberStatus) {
			case "SILVER": loyaltyMemberStatus = "GOLD";
				break;
			case "GOLD": loyaltyMemberStatus = "PLATINUM";
				break;
			default: loyaltyMemberStatus = "SILVER";
				break;
			}
		}
